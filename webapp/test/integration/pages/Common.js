sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/test/app", ".html");
		...
		return Opa5.extend("zjblessons.test.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/test/localService/mockserver"], function (mockserver) {
